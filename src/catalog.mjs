export const catalog = [
  {
    ...
    summary:
      '센서와 영상 데이터를 결합해 배터리 이상 징후를 빠르게 탐지하는 국내 대표 연구입니다.',
    novelty:
      '생산 설비 로그와 적외선 이미지를 동시에 사용하는 현장형 추론 파이프라인을 제시합니다.',
    methods: ['Transformer', '그래프 특징 추출', '실시간 알림'],
    highlights: ['산업 현장 적용', '국내 데이터셋', '설비 안전성'],
    sourceUrl: 'https://example.local/paper-ko-energy-ai.pdf'
  },
  {
    id: 'paper-ko-semiconductor',
    type: 'paper',
    region: 'domestic',
    ...
    summary:
      '반도체 결함의 원인 설명과 공정 개선 제안을 동시에 제공하는 산업형 연구입니다.',
    novelty:
      '설명가능성 지표를 공정 엔지니어 워크플로우에 직접 연결합니다.',
    methods: ['Vision Transformer', 'SHAP', '룰 기반 추천'],
    highlights: ['제조 현장 적용', '설명가능성', '품질 개선'],
    sourceUrl: 'https://example.local/paper-ko-semiconductor.pdf'
  },
  {
    id: 'paper-global-quantum',
    type: 'paper',
    region: 'global',
    ...
    summary:
      '학술 그래프와 벡터 검색을 결합한 차세대 검색 엔진 설계에 적합한 글로벌 논문입니다.',
    novelty:
      '인용 그래프와 멀티모달 임베딩을 동시에 랭킹에 반영합니다.',
    methods: ['Hybrid ranking', 'Dense retrieval', 'Citation graph'],
    highlights: ['Open access', 'Retrieval infra', 'Similarity search'],
    sourceUrl: 'https://example.local/paper-global-quantum.pdf'
  },
  {
    id: 'paper-global-climate',
    type: 'paper',
    region: 'global',
    ...
    summary:
      '정책 연구와 근거 요약 워크플로우를 함께 다루는 기후 리스크 연구입니다.',
    novelty:
      '대형 예측 모델 결과를 정책 연구자가 이해하기 쉬운 근거 묶음으로 축약합니다.',
    methods: ['Distillation', 'Scenario ranking', 'Evidence summarization'],
    highlights: ['Policy-ready', 'Forecast evidence', 'Open dataset'],
    sourceUrl: 'https://example.local/paper-global-climate.pdf'
  },
  {
    id: 'patent-ko-edge-medical',
    type: 'patent',
    region: 'domestic',
    ...
    abstract:
      '의료 영상 장비 가까이에 추론 노드를 배치하여 지연 시간을 줄이는 엣지 기반 판독 보조 특허.',
    summary:
      '실시간 추론과 프라이버시 요구를 동시에 만족시키는 의료 AI 특허입니다.',
    novelty:
      '현장 장비 인접 추론으로 개인정보 이동을 최소화합니다.',
    methods: ['Edge inference', 'Latency control'],
    highlights: ['Low latency', 'Privacy aware'],
    sourceUrl: 'https://example.local/patent-ko-edge-medical.pdf'
  },
  {
    id: 'report-ko-bio',
    type: 'report',
    ...
    abstract:
      '국가 차원의 바이오 파운드리 구축 전략과 연구 장비, 데이터 표준화, 인력 양성 로드맵을 정리한 보고서.',
    summary:
      '정책/투자 관점에서 연구 주제 확장성을 확인할 수 있는 보고서입니다.',
    novelty:
      '연구 인프라 투자 판단에 필요한 로드맵과 KPI를 제시합니다.',
    methods: ['정책 비교', '로드맵 설계'],
    highlights: ['정책 적합성', '투자 로드맵'],
    sourceUrl: 'https://example.local/report-ko-bio.pdf'
  },
  {
    id: 'report-global-ai-governance',
    type: 'report',
    region: 'global',
    title: 'Global AI Governance Playbook for Research Institutions',
    englishTitle: 'Global AI Governance Playbook for Research Institutions',
    authors: ['OECD Research Futures Unit'],
    organization: 'OECD',
    source: 'OECD',
    year: 2024,
    citations: 33,
    openAccess: true,
    keywords: ['AI governance', 'research security', 'compliance', 'policy'],
    abstract:
      'A governance playbook covering model controls, data handling, and research security for institutions adopting AI-assisted discovery.',
    summary:
      '보안과 운영 정책을 함께 검토할 때 참고할 수 있는 국제 보고서입니다.',
    novelty:
      '연구기관 운영 기준과 AI 보안 통제를 함께 제시합니다.',
    methods: ['Governance framework', 'Security checklist'],
    highlights: ['Security', 'Compliance', 'Operations'],
    sourceUrl: 'https://example.local/report-global-ai-governance.pdf'
  }
];
