...
export function toUiPaperShape(item = {}) {
  ...
  return {
    ...
    relevanceEvidence: {
      titleCoverage: item.titleCoverage || 0,
      keywordCoverage: item.keywordCoverage || 0,
      semanticTitleCoverage: item.semanticTitleCoverage || 0,
      orderedPhraseCoverage: item.orderedPhraseCoverage || 0,
